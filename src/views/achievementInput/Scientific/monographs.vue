      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="所属学科：" prop="subordinateSubject">
            <el-input v-model="form.subordinateSubject" placeholder="请输入..." :disabled="disable" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="10">
          <el-form-item label="主 题 词：" prop="themeWord">
            <el-input v-model="form.themeWord" placeholder="请输入..." :disabled="disable" />
          </el-form-item>
        </el-col>
        <el-col :span="2">&nbsp;</el-col>
        <el-col :span="12">
      ...
      <el-row>
        <el-col :span="10">
          <el-form-item label="作者名称：" prop="authorName">
            <el-input v-model="form.authorName" placeholder="请输入..." :disabled="disable" />
          </el-form-item>
        </el-col>
        <el-col :span="2">&nbsp;</el-col>
        <el-col :span="12">
          <el-form-item label="总 字 数：" prop="wordNumber">
            <el-input v-model="form.wordNumber" placeholder="请输入..." :disabled="disable" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="10">
          <el-form-item label="出版册数：" prop="publishedNumber">
            <el-input v-model="form.publishedNumber" placeholder="请输入..." :disabled="disable" />
          </el-form-item>
        </el-col>
        <el-col :span="2">&nbsp;</el-col>
        <el-col :span="12">
...
import { getUserRole, getFileNameById, check, delFile,getMonographs,updataMonographs,insertMonographs } from "@/api/achievementinput";
export default {
  props: ["table"],
  data() {
    return {
  ...
  mounted() {
     if (this.table != undefined && this.table != null) {
      getMonographs({ tableId: this.table.tableId }).then(res => {
  ...
  methods: {
    ...
    onSubmit(form) {
      this.$refs[form].validate(valid => {
        if (valid) {
          insertMonographs(this.form).then(res => {
            this.clear()
          })
        } else {
          return false
