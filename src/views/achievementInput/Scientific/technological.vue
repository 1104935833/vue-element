      ...
      <el-row>
        ...
        <el-col :span="10" :offset="2">
          <el-form-item label="申报单位：" prop="declareUnit">
            <el-input v-model="form.declareUnit" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
      </el-row>
      <!--第2行-->
      <el-row>
        <el-col :span="10">
          <el-form-item label="计划类别：" prop="planCategory">
            <el-input v-model="form.planCategory" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="2">
          <el-form-item label="专题名称：" prop="specialName">
            <el-input v-model="form.specialName" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
      </el-row>
      <!--第3行-->
      <el-row>
        ...
        <el-col :span="10">
          <el-form-item label="支持单位：" prop="supportUnit">
            <el-input v-model="form.supportUnit" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
        <!--第3行第2列-->
        <el-col :span="10" :offset="2">
      ...
      <el-row>
        ...
        <el-col :span="10">
          <el-form-item label="组织单位：" prop="organizationUnit">
            <el-input v-model="form.organizationUnit" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
        <el-col :span="12" :offset="2">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item label="申报单位名称：" prop="declareUnitName">
            <el-input v-model="form.declareUnitName" placeholder="请输入内容" :disabled="disable" />
          </el-form-item>
        </el-col>
      </el-row>
...
export default {
  ...
  mounted() {
    if (this.table != undefined && this.table != null) {
      getTechnological({ tableId: this.table.tableId }).then(res => {
  ...
  methods: {
    ...
    onSubmit(form) {
      this.$refs[form].validate(valid => {
        if (valid) {
          insertTechnological(this.form).then(res => {
            this.clear();
          });
        } else {
          return false;
