        ...
        <el-main style="padding-left: 0px;padding-top: 0px">
          <div>
            ...
            >
              ...
              <el-table-column prop="path" align="left" fixed label="访问路径" />
              <el-table-column prop="url" align="left" fixed label="请求路径" />
              <el-table-column prop="component" align="left" fixed label="模块名称" />
              <el-table-column prop="name" align="left" fixed label="标题" />
              <el-table-column prop="parent" align="left" fixed label="类型" />
...
import { getAllMenus, menuDel, menuHide, getAllParent, upMenu, addMenu} from '@/api/system'
export default {
  name: 'IconSelect',
  data() {
    return {
      ...
      this.$refs['EditForm'].validate(valid => {
        if (valid) {
          ...
          if (!this.isEdit) {
            ...
            upMenu({ form: this.form }).then(res => {
              this.init()
              this.loadEmps()
              this.EditVisible = false
            })
