      ...
      <el-container>
        <el-header style="padding: 0px;display:flex;justify-content:space-between;align-items: center">
          ...
          <div style="margin-left: 5px;margin-right: 20px;display: inline">
            ...
            <el-button type="success" size="mini" @click="template"><i class="fa fa-lg fa-level-down"
                                                                        style="margin-right: 5px"></i>模板下载
            </el-button>
    ...
    methods: {
      ...
      loadNode(node, resolve) {
        ...
        setTimeout(() => {
          var data;
          if(node.level==1){
            this.getRequest("/system/role/treepeople",{name:node.data.name}).then(res=>{
              data=res.data
              resolve(data);
            })
          }
